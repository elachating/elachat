...
public class MsgBox {
     ...
     */
    public Dialog showNoticeDialog(OnClickListener onClickListener,OnClickListener cancelClickListener,String contents) {
        if (noticeDialog == null) {
            ...
            builder.setNeutralButton(msgHelper.getString(MsgHelper.UPDATE_CANCEL_BTN),cancelClickListener);
